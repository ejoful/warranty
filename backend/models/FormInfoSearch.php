...
class FormInfoSearch extends FormInfo
{
    ...
    {
        return [
            [['id', 'firstlevel_problem', 'secondlevel_problem', 'status'], 'integer'],
            [['consumer_name', 'consumer_phone', 'watch_id', 'email', 'country', 'address', 'problem_des', 'photo', 'video', 'create_time', 'update_time'], 'safe'],
        ];
    }
